...
interface SelectProps extends React.ComponentPropsWithRef<typeof BaseSelect.Root> {
  /**
...
interface SelectValueProps extends Omit<BaseSelect.Value.Props, "children"> {
  placeholder?: string;
  children?: BaseSelect.Value.Props["children"];
}

interface SelectPositionerProps extends BaseSelect.Positioner.Props {}

interface SelectPopupProps extends Omit<BaseSelect.Popup.Props, "className"> {
  className?: string;
}

interface SelectListProps extends Omit<BaseSelect.List.Props, "className"> {
  className?: string;
}

interface SelectOptionProps extends Omit<BaseSelect.Item.Props, "className"> {
  className?: string;
}
