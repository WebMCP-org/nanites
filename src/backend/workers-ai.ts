...
export function createPromptCachedWorkersAIModel(input: PromptCachedWorkersAIModelInput) {
...
export function appendUserTextContext(
  ...
  if (!lastMessage || lastMessage.role !== "user") {
    return [...messages, { role: "user", content: trimmedContext }];
  }
  ...
  return [
    ...
    {
      ...lastMessage,
      content: [...lastMessage.content, { type: "text", text: trimmedContext }],
    },
  ];
}
