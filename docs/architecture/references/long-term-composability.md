...
- [NaniteManagerState](/src/backend/agents/SigveloNaniteManager.ts) is small and dispatch-oriented.
- [NaniteAgentState](/src/backend/agents/SigveloNaniteAgent.ts) is the durable worker-owned state.
...
- [NaniteAgentState](/src/backend/agents/SigveloNaniteAgent.ts)
