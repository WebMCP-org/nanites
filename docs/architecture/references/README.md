...
This directory holds supporting technical notes and source indexes.

These files are reference material, not the active product direction.

Use these first instead:
...
- `think-migration-guide.md` for archived Think migration context and still-useful context hygiene, attempt boundary, and operator escape-hatch guidance
